...
func createContextFromArgumentParsing() context.Action {
...
func overrideFromEnvironment(ctx context.Action, passphrase string, recipient string) (string, string, context.Action) {
...
func triggerMakeAction(ctx context.Action) error {
...
func triggerRestoreAction(ctx context.Action) error {
...
func triggerDownloadAction(ctx context.Action) error {
